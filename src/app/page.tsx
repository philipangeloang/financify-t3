...
export default async function Home() {
  ...
  return (
    <main className="relative mx-auto mt-16 flex max-w-full flex-col items-center justify-center p-4">
      ...
      <div className="relative mt-8 text-center text-[3.25rem] leading-[4.5rem]">
        ...
        <div>
          ...
          <span className="rounded-full shadow-md shadow-main-green">ease</span>
        </div>
      </div>
